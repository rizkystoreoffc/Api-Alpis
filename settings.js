...
creator = '乂𝙍𝙞𝙯𝙯𝙈𝙤𝙙𝙯乂' // Nama 
port = 8080 //port host
LimitApikey = 200 // Limit Apikey default

//___________ ┏  Database Mongodb Setting  ┓ ___________\\

keymongodb = mongodb+srv://syakirah3310:N6Eb3way8a1QSUOM@cluster0.7qtn6uk.mongodb.net/?retryWrites=true&w=majority
...
sendemail = no-reply@rizzpedia.biz.id //Email SMTP
fromsendemail = no-reply@rizzpedia.biz.id // From Email SMTP *kalau takde custom email kena sama email dengan Email SMTP
sendpwmail = eRHMrkjX6cTuzgG // Password Email SMTP
domain = 'rizzpedia.biz.id'// domain website tanpa http or https
